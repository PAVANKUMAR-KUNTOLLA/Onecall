/**
 *	onecall - Creative Portfolio Agency HTML Template
 *	Version: 1.1
 *	Author: bslthemes
 *	Author URL: http://themeforest.net/user/bslthemes
 *	Copyright © onecall by bslthemes. All Rights Reserved.
 **/
...
(function ($) {
  ...
  /**
	...
	**/
  Splitting({ by: "lines" });
  ScrollOut({ targets: "[data-onecall-scroll]", once: true });

  $(".word").wrap("<span></span>");
  $("[data-onecall-overlay]").append('<div class="onecall-overlay"></div>');

  /**
		Header Sticky
	**/
  if ($(".onecall-header").length) {
    var new_scroll_position = 0;
    var last_scroll_position;
    $(window).on("scroll", function () {
      var header = $(".onecall-header");
  ...
  $(document).ready(function () {
    ...
    // Your existing click event handler for the .onecall-menu-btn
    $(".onecall-menu-btn").on("click", function () {
      var obj = $(this);

      if (obj.hasClass("btn--active")) {
        // Menu is closing
        $("body").removeClass("onecall--noscroll");
        $(".onecall-header").removeClass("header--active");
        obj.removeClass("btn--active");
        obj.addClass("onecall--notouch");
        obj.parent().find(".onecall-menu-popup").removeClass("menu--ready");
        obj
          .parent()
          .find(".onecall-menu-container")
          .addClass("onecall--noscroll");
        setTimeout(function () {
          obj.parent().find(".onecall-menu-popup").removeClass("menu--open");
        }, 300);
        setTimeout(function () {
          obj.removeClass("onecall--notouch");
          obj.parent().find(".onecall-menu-popup").removeClass("menu--visible");
        }, 300);
        ...
        // Menu is opening
        $("body").addClass("onecall--noscroll");
        $(".onecall-header").addClass("header--active");
        obj.addClass("btn--active");
        obj.addClass("onecall--notouch");
        obj.parent().find(".onecall-menu-popup").addClass("menu--visible");
        obj.parent().find(".onecall-menu-popup").addClass("menu--open");
        setTimeout(function () {
          obj.removeClass("onecall--notouch");
          obj
            .parent()
            .find(".onecall-menu-container")
            .removeClass("onecall--noscroll");
          obj.parent().find(".onecall-menu-popup").addClass("menu--ready");
    ...
    $(".onecall-menu-nav a").on("click", function (e) {
      e.preventDefault(); // Prevent the default behavior of the anchor link
      var targetId = $(this).attr("href"); // Get the href attribute of the clicked link

      // Close the menu
      $(".onecall-menu-btn.btn--active").removeClass("btn--active");
      $(".onecall-menu-popup").removeClass("menu--visible");
      $("body").removeClass("onecall--noscroll");
      $(".onecall-header").removeClass("header--active");
      ...
      $("html, body").animate(
        {
          scrollTop: $(targetId).offset().top - $(".onecall-header").height(),
        },
        1000
      );
    });
  ...
  /*
		Top Menu Close
	*/
  $(".onecall-menu").on("click", "a", function () {
    if (!$(this).parent().hasClass("menu-item-has-children")) {
      $(".onecall-header .onecall-menu-btn.btn--active").trigger("click");
    }
  });
  ...
  if ($(".footer--fixed").length) {
    var footer_fixed = $(".footer--fixed .onecall-footer").height();
  ...
  /*
		Intro Style
	*/
  if ($(".onecall-intro.intro--black").length) {
    $(".onecall-header").addClass("header--white");
  }
  ...
  $(".js-hero-parallax").each(function () {
    ...
    heroParallax.pagepiling({
      ...
      sectionSelector: ".onecall-hero-parallax-section",
      afterRender: function () {
        if (
          heroParallax
            .find(".onecall-hero-parallax-section.active")
      ...
      afterLoad: function (anchorLink, index) {
        var current = heroParallax.find(
          ".onecall-hero-parallax-section.active"
        );
  ...
  function setDark() {
    $(".onecall-page").addClass("parallax--dark");
    $(".onecall-header").removeClass("header--white");
    $(".onecall-hero-parallax .onecall-prev").removeClass("nav--white");
    $(".onecall-hero-parallax .onecall-next").removeClass("nav--white");
  }
  function removeDark() {
    $(".onecall-page").removeClass("parallax--dark");
    $(".onecall-header").addClass("header--white");
    $(".onecall-hero-parallax .onecall-prev").addClass("nav--white");
    $(".onecall-hero-parallax .onecall-next").addClass("nav--white");
  }
  ...
  $(".js-hero-slider").each(function () {
    ...
    heroMainSwiper
      .find(".onecall-paginations-container")
  ...
  /*
	...
	*/
  $(".onecall-play-btn").on("click", function () {
  ...
  /*
		- Services Hover
	*/
  $(".onecall-service-grid-item.active--default").each(function () {
    $(this)
      .closest(".onecall-services-grid-fw")
      .hover(
        function () {
          if (
            $(this)
              .find(".onecall-service-grid-item")
              .hasClass("active--default")
          ) {
            $(this).find(".onecall-service-grid-item").removeClass("active");
          }
        },
        function () {
          if (
            ...
            $(this)
              .find(".onecall-service-grid-item.active--default")
              .addClass("active");
          }
        }
      );
  ...
  /*
		- Number Text
	*/
  $(".onecall-circle-text .label").each(function () {
    $(this).html(
      $(this)
        .text()
        .split("")
  ...
  /*
	...
	*/
  if ($(".onecall-showcase-items").length) {
    $(".onecall-showcase-items")
      .find(".onecall-showcase-item:first-child")
      .addClass("hover");
  }
  $(".onecall-showcase-item").mouseenter(function () {
    var obj = $(this);
    obj
      .closest(".onecall-showcase-items")
      .find(".onecall-showcase-item")
      .removeClass("hover");
    obj.addClass("hover");
  });
  ...
  /*
	...
	*/
  if ($(window).width() > 767) {
    if ($(".onecall-services-showcase").length) {
      $(".onecall-services-showcase")
        .find(".items ul li:first-child")
        .addClass("hover");
    }
    $(".onecall-services-showcase .items ul li .title").mouseenter(function () {
  ...
  /**
		- Video
	**/
  $(".onecall-video").on("click", ".play, .image", function () {
    $(this).closest(".onecall-video").addClass("active");
    var iframe = $(this).closest(".onecall-video").find(".js-video-iframe");
  ...
  /*
		- onecall Button
	*/
  $("button.onecall-btn.onecall-hover-btn").each(function () {
  ...
  $(".pager").each(function () {
    ...
    btn_next.html("<i></i>");
    btn_prev.html("<i></i>");
    btn_next.addClass("onecall-next onecall-hover-2");
    btn_prev.addClass("onecall-prev onecall-hover-2");
  });

  /*
		- onecall Portfolio
	*/
  var $container = $(".onecall-portfolio-items");
  $container.imagesLoaded(function () {
    $container.isotope({
      itemSelector: ".onecall-portfolio-col",
  ...
  /*
		- onecall Filter
	*/
  $(".onecall-filter-nav-active").each(function () {
    $(this).css({
      width:
        $(this)
          .closest(".onecall-filter.filter--default")
          .find(".item--active")
          .parent()
          .width() +
        6 +
  ...
  $(".onecall-filter").on("click", "button", function () {
    ...
    $(this)
      .closest(".onecall-filter.filter--default")
      .find(".onecall-filter-nav-active")
  ...
  /**
		Collapse
	**/
  $(".onecall-collapse-item").on("click", ".onecall-collapse-btn", function () {
    if ($(this).closest(".onecall-collapse-item").hasClass("opened")) {
      $(this).closest(".onecall-collapse-item").removeClass("opened");
      $(this).removeClass("active");
      $(this).next().slideUp();
    } else {
      $(this).closest(".onecall-collapse-item").addClass("opened");
      $(this).addClass("active");
      $(this).next().slideDown();
    }
  });
